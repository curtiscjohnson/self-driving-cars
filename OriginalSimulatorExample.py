...
cameraSettings = {
    ...
    "angle": {"roll": 0, "pitch": -10, "yaw": 0}, # don't go too crazy with these, my code should be good up to like... 45 degrees probably? But the math gets unstable
...
sim.start(mapSeed=seed, mapParameters=mapParameters, carParameters=carParameters, startPoint=(0,1,0,1))
